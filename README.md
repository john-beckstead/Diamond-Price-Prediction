...
a Databricks workspace, and run the file. This produces 3 runs each of 3 different machine learning algorithms: Random Forest, SVR, and XGBoost. In my testing, the SVR runs took
